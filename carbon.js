...
const pufferplanetPage = document.getElementById('pufferplanet');
const formplanet1Page = document.getElementById('formplanet1');
...
document.getElementById('puffplanet').addEventListener('click', () => {
    showPage(pufferplanetPage);
...
document.getElementById('купить1').addEventListener('click', () => {
    showPage(formplanet1Page);
    // Оставляем кнопку назад
    Telegram.WebApp.onEvent('backButtonClicked', () => {
        showPage(pufferplanetPage);
    });
...
// По умолчанию скрываем кнопку "Назад"
backButton.hide();
